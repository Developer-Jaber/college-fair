...
export default function MyCollegePage () {
  ...
  if (!applications.length) {
    return (
      <div className='flex justify-center items-center py-12 min-h-screen text-center'>
        <div>
          ...
          <button
            ...
            className='bg-[var(--accent)] hover:bg-gray-50 my-5 px-8 py-3 border-2 border-primary rounded-lg font-semibold text-[white] hover:text-[var(--text)] transition-all'
          >
            Apply Now
          </button>
        </div>
  ...
  return (
    <div className='mx-auto px-4 py-40 max-w-6xl'>
              ...
              <div className='flex justify-between items-start'>
                ...
                <div className='flex space-x-2'>
                  <button
                    ...
                    onClick={() =>
                      router.push(`/edit-application/${application._id}`)
                    }
                  >
                    <FiEdit />
                  </button>
